...
class TransactionControllerTest {
  ...
  void testCredit_ReturnsOk() throws Exception {
    ...
    when(transactionService.creditAccount(any(CreditDebitRequest.class)))
  ...
  void testDebit_ReturnsOk() throws Exception {
    ...
    when(transactionService.debitAccount(any(CreditDebitRequest.class)))
        .thenReturn(expectedResponse);
  ...
  void testTransfer_ReturnsOk() throws Exception {
    ...
    BankResponse expectedResponse =
        BankResponse.builder().responseCode(AccountUtils.TRANSACTION_SUCCESSFUL_CODE).build();
