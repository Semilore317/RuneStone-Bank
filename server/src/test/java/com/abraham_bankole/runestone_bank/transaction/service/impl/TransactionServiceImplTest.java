...
class TransactionServiceImplTest {
    ...
    void testTransfer_WhenReceiverDoesNotExist_ReturnsError() {
        com.abraham_bankole.runestone_bank.transaction.dto.TransferRequest request = 
             com.abraham_bankole.runestone_bank.transaction.dto.TransferRequest.builder().sender("111").receiver("222").amount(BigDecimal.valueOf(100)).build();
    ...
    void testTransfer_WhenInsufficientBalance_ReturnsError() {
        com.abraham_bankole.runestone_bank.transaction.dto.TransferRequest request = 
             com.abraham_bankole.runestone_bank.transaction.dto.TransferRequest.builder().sender("111").receiver("222").amount(BigDecimal.valueOf(500)).build();
