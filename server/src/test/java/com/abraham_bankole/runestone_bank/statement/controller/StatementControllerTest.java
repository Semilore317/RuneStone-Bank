...
class StatementControllerTest {
    ...
    void testGenerateBankStatement_ReturnsOk() throws Exception {
        ...
        when(bankStatementService.generateStatement("123", "2023-01-01", "2023-12-31")).thenReturn(list);

        mockMvc.perform(get("/api/v1/bankstatement")
    ...
    void testRequestStatementByEmail_ReturnsOk() throws Exception {
        when(bankStatementService.generateStatement("123", "2023-01-01", "2023-12-31")).thenReturn(Collections.emptyList());

        mockMvc.perform(post("/api/v1/bankstatement/email")
                .param("accountNumber", "123")
                .param("start", "2023-01-01")
                .param("end", "2023-12-31")
                .contentType(MediaType.APPLICATION_JSON))
