...
public class UserController {
  ...
  @PutMapping("/profile")
  @PreAuthorize("hasAuthority('ROLE_ADMIN') or #accountNumber.equals(principal.accountNumber)")
  public BankResponse updateProfile(
      @RequestParam String accountNumber, @RequestBody ProfileUpdateRequest request) {
  ...
  @PutMapping("/password")
  @PreAuthorize("hasAuthority('ROLE_ADMIN') or #accountNumber.equals(principal.accountNumber)")
  public BankResponse updatePassword(
      @RequestParam String accountNumber, @RequestBody PasswordUpdateRequest request) {
