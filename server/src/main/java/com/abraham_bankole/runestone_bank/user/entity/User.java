...
public class User implements UserDetails {
  ...
  @Builder.Default private Boolean emailNotifs = true;
  @Builder.Default private Boolean loginAlerts = true;
  @Builder.Default private Boolean transferAlerts = false;
  ...
  public String getFullName() {
    ...
    if (otherName != null
        ...
        && !otherName.trim().equalsIgnoreCase("null")) {
