  ...
  fun handleUserRegistered(event: UserRegisteredEvent) {
    val details =
      EmailDetails().apply {
        ...
        messageBody =
          String.format("Hello ${event.firstName}, welcome to your new account.", event.firstName)
  ...
  fun handleTransactionCompleted(event: TransactionCompletedEvent) {
    ...
    val debitAlert =
      EmailDetails().apply {
        ...
        messageBody =
          "You have successfully sent the sum of ${event.amount()} to ${event.receiverName} and your account has been debited."
      }
    ...
    emailService.sendEmailAlert(
      EmailDetails().apply {
        ...
        messageBody =
          "The sum of ${event.amount()} has been sent to your account from ${event.senderName()}."
      }
    )
