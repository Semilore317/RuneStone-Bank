...
export async function fetchBalance(
  ...
  return apiRequest<BalanceResponse>(
    `/api/v1/user/balanceEnquiry?accountNumber=${accountNumber}`,
    {
      method: "GET",
    },
...
export async function fetchRecentTransactions(
  ...
  const response = await apiRequest<Transaction[]>(
    `/api/v1/transactions/history?accountNumber=${accountNumber}`,
    {
      method: "GET",
    },
  );
...
export async function lookupAccountName(
  ...
  return apiRequest<NameEnquiryResponse>(
    `/api/v1/user/nameEnquiry?accountNumber=${accountNumber}`,
    {
      method: "GET",
    },
...
export async function fetchProfile(
  ...
  const response = await apiRequest<UserProfileResponse>(
    `/api/v1/user/profile?accountNumber=${accountNumber}`,
    {
      method: "GET",
    },
  );
